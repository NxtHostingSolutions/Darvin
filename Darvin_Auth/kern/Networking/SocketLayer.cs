...
namespace Darvin_Auth.kern.Networking
{
    class SocketLayer
    {
        ...
        public class AsynchronousSocketListener
        {
            ...
            public static void ReadCallback(IAsyncResult ar)
            {
                ...
                if (bytesRead > 0)
                {
                    ...
                    string data = content.Substring(0, content.Length - 5);
            ...
            {
                Auth.AuthProcessor authproc = new Auth.AuthProcessor();
                return authproc.Auth_Token(token);
            }
        ...
        public class AsynchronousClient
        {
            ...
            public static void StartClient()
            {
                ...
                try
                {
                    ...
                    //string data = configdata.Auth_Key() + "<EOF>";
                    //Send(client, data);
                    sendDone.WaitOne();
