...
namespace DarvinCore.kernel.api.google.auth
{
    class BaseOptions
    {
        string _projectId;
        [Option('p', Default = null, HelpText = "darvin-cloud-ai ")]
        public string ProjectId
        {
            get
            {
                if (null == _projectId)
                {
                    _projectId = Environment.GetEnvironmentVariable("w");
                    if (null == _projectId)
                    {
